      ...
      >
        <div className="flex min-w-0 justify-between items-start gap-3 p-6 sticky top-0 bg-white/90 backdrop-blur-sm z-10 min-h-[72px] border-b border-gray-50 shrink-0">
          <div className="min-w-0 flex-1 text-left">
            ...
            {entry.managementName && <p className="mt-1 text-[11px] font-black text-[#FF9800] break-words">血統: {entry.managementName}</p>}
            {entry.bloodline && <p className="mt-1 text-[11px] font-black text-[#A67C52] break-words">紐付けデータあり</p>}
          </div>
